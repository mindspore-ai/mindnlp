...
from mindtext.modules.encoder.xlnet import XLNetConfig, XLNetModel, XLNetForClassification, XLNetFinetuneCell
...
def train_main(config):
    ...
    netwithgrads = XLNetFinetuneCell(model, optimizer=optimizer, scale_update_cell=update_cell)
