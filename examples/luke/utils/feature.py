...
def _process_example(args):
    ...
    features = feacture_extract(all_doc_tokens, doc_spans, example, example_index, query_tokens, tok_end_positions,
                                tok_start_positions, tok_to_orig_index)

    return features


def feacture_extract(all_doc_tokens, doc_spans, example, example_index, query_tokens, tok_end_positions,
                     tok_start_positions, tok_to_orig_index):
    """
